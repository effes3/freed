...
def brics_compatible(bond_type):
    # Универсальный набор Side B (Галогениды)
    cross_coupling_partners = {17, 19, 20, 21, 22, 23, 24, 25}
    
    connection_rules = {
        # Стандартный BRICS (0-14)
        0: {1, 3, 8}, 1: {0, 2, 11, 12, 13, 14}, 2: {1, 3, 9}, 
        3: {0, 2, 10, 11, 12, 13, 14}, 4: {11, 12, 13, 14}, 5: {5}, 
        6: {7, 8, 11, 12, 13, 14}, 7: {6, 11, 12, 13, 14}, 8: {0, 6, 11, 12, 13, 14}, 
        9: {2, 11, 12, 13, 14}, 10: {3}, 11: {1, 3, 4, 6, 7, 8, 9, 12, 13, 14}, 
        12: {1, 3, 4, 6, 7, 8, 9, 11, 12, 13, 14}, 13: {1, 3, 4, 6, 7, 8, 9, 11, 12, 14}, 
        ...
        # Все кросс-сочетания Side A -> Side B (18)
        17: {18}, 19: {18}, 20: {18}, 21: {18}, 
        22: {18}, 23: {18}, 24: {18}, 25: {18},

        # Side B (18) -> Все Side A
        18: cross_coupling_partners
    }
    return connection_rules.get(bond_type, set())
